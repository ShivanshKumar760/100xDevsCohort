...
1.Properties that dont exist in js  object evaluate to undefined unlike other language say like python which will thow an error but in JavaScript if we try and access a property that dosent exist we just get undefined until we define it and add as new key.
